const STORAGE_KEY = 'badgers-end-project-plan-v2';
  ...
  const WEATHER = [
    ...
    `Steady rain all day, turning the lower quarters to mud`,
  ...
  const RUMORS = [
    ...
    `"The Coin's buying up debts all over the low quarter. Cheap. Why now?"`,
    ...
    `Two children swear the well in the low quarter answered them back`,
