...
The shared campaign reference (rules, factions, NPCs, lore) now lives in its own themed
wiki — the **[Badger's End Game Wiki](https://litzylowe.github.io/badgers-end-wiki/)**
([repo](https://github.com/litzylowe/badgers-end-wiki)), linked from the footer. Individual
DMs keep their own private notes separately.
